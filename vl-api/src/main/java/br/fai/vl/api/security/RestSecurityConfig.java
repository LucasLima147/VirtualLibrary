...
public class RestSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(final HttpSecurity http) throws Exception {
		...
		.addFilterAfter(new JWTAuthorizationFilter(), UsernamePasswordAuthenticationFilter.class)
				...
				.antMatchers(HttpMethod.GET, "/api/v1/entrega/check-delivery-request/**/**")
				.hasAnyRole("BIBLIOTECARIO", "LEITOR").antMatchers(HttpMethod.POST, "/api/v1/entrega/create")
				.hasAnyRole("LEITOR")
				// recolhimento
				.antMatchers(HttpMethod.GET, "/api/v1/recolhimento/pickup-order-list").hasRole("BIBLIOTECARIO")
				.antMatchers(HttpMethod.GET, "/api/v1/recolhimento/request-collection/**/**")
				.hasAnyRole("BIBLIOTECARIO", "LEITOR")
				...
				// emprestimo
				.antMatchers(HttpMethod.GET, "/api/v1/emprestimo/check-loan/**/**")
				.hasAnyRole("BIBLIOTECARIO", "LEITOR")
